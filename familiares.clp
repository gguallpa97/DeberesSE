...
(deffacts inicio
	  ...
	  (mujer Ariana)
	  (mujer Amanda)
      (progenitor-de Gustavo Franklin)
      (progenitor-de Gustavo Pedro)
      (marido-de Gustavo Rosa)
      (progenitor-de Franklin Rafael)
	  (marido de Franklin Andrea)
      (marido de Pedro Diana)
      (progenitor-de Pedro Jhony)
	  (progenitor-de Pedro Amanda)
	  (progenitor-de Rafael Patricio)
	  (progenitor-de Jhony Ariana)
)
